...
const prefix = "^";
client.on('ready', () => {
  client.user.setGame('ShiftMC | ^help','https://www.twitch.tv/peery13');
  console.log('---------------');
...
client.on('message', message => {
    if(message.channel.type === 'dm') {
        var guildID = '463279805408870410'; // <=============== ايدي السيرفر حقك
...
client.on('message', message => {
    ...
    var omar;
      if(mentionned){
        ...
        .setFooter('ShiftMC',client.user.avatarURL) 
